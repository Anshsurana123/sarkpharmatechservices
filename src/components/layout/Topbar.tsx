...
export function Topbar() {
    ...
    const handleSignOut = async () => {
        ...
        // Optionals: reload or leave on same page, store listener handles state
    };
    return (
        <header className="sticky top-0 z-30 flex h-16 shrink-0 items-center justify-between gap-4 border-b bg-background px-4 md:px-6 shadow-sm">
