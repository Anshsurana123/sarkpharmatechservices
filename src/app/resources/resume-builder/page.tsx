    ...
    return (
        <div className="max-w-7xl mx-auto pb-16 space-y-8">
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-start">
                ...
                {/* Preview Section */}
                <div className="sticky top-24 bg-white border shadow-xl p-8 lg:p-12 min-h-[A4] w-full text-foreground print:shadow-none print:border-none print:p-0 print:m-0" id="resume-preview">
                    ...
                    <div className="border-b-2 border-primary pb-4 mb-6 text-center">
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-sm text-foreground/80">
                    ...
                    {summary && (
                        <div className="mb-6">
                            <h3 className="text-lg font-bold uppercase tracking-wider border-b border-muted pb-1 mb-3 text-primary/80">Professional Summary</h3>
                    ...
                    {(experience.length > 0 && experience[0].role !== '') && (
                        <div className="mb-6">
                            <h3 className="text-lg font-bold uppercase tracking-wider border-b border-muted pb-1 mb-3 text-primary/80">Professional Experience</h3>
                                    ...
                                    <div key={exp.id}>
                                        <div className="flex items-start justify-between mb-1">
                                            <div>
                                                ...
                                                <p className="text-sm font-medium italic text-foreground/80">{exp.company || 'Company Name'}</p>
                                            </div>
                                            <span className="text-sm font-medium whitespace-nowrap">{exp.dates || 'Dates'}</span>
                                        </div>
                                        {exp.description && (
                                            <p className="text-sm leading-relaxed whitespace-pre-wrap ml-0 sm:ml-4 text-foreground/90">{exp.description}</p>
                                        )}
                                    </div>
                                ))}
                            </div>
                    ...
                    {(education.length > 0 && education[0].degree !== '') && (
                        <div className="mb-6">
                            <h3 className="text-lg font-bold uppercase tracking-wider border-b border-muted pb-1 mb-3 text-primary/80">Education</h3>
                                ...
                                {education.map(edu => (
                                    <div key={edu.id} className="flex flex-col sm:flex-row sm:items-start sm:justify-between">
                                        <div>
                                            ...
                                            <p className="text-sm italic text-foreground/80">{edu.institution || 'Institution'}</p>
                                        </div>
                    ...
                    {skills && (
                        <div className="mb-6">
                            <h3 className="text-lg font-bold uppercase tracking-wider border-b border-muted pb-1 mb-3 text-primary/80">Core Competencies</h3>
